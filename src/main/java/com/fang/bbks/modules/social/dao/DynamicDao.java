 ...
 * @since 下午6:21:10	
 */
public interface DynamicDao extends DynamicDaoCustm, CrudRepository<Dynamic, Integer>{
	@Modifying
	...
	public List<Dynamic> findByCreatBy(Integer creatBy);
...
interface DynamicDaoCustm extends BaseDao<Dynamic>{
	 ...
	 * @return
	 */
	public List<Dynamic> groupDynamics(User u, List<Integer> uids); 
}
