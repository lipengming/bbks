...
$(function() {
	...
	// }
	// });
	$("#layout .info .doing .con .fb .fb_btn .btn,.fb_list a").click(
			function() {
	...
	$(".book_info").hide();
	$(
			".sidebar .now_read .read_list ul li,.tab_con dl dd,.tab .tab_con .book_img,.con_list .col ul li,.interest_list .bk_img")
			.hover(function() {
	...
	// 书信息弹出喜欢
	$(".book_info_btn .text").click(function() {
	...
	$(
			".tab .tab_con .tab_list li .img,.person_tab .tab_con ul li .img,.circle_right .interest_list .hd .img,.dr_list .list dd .img,.cs_list ul li .img,.zr_list dd .img")
			.hover(function() {
				var reader = $(this).find(".read_info");
				var po = $(this).position();
				reader.show();
	...
	$(".book_info_btn .join").click(function() {
		...
		// 弹出层下拉按钮
		$(".bookshelf .read .s").click(function() {
			$(this).next(".more_list").toggle();
		});
		// 弹出层标签删除
		$(".read_span a .x").click(function() {
			$(this).parents("a").hide();
			return false;
		});
	});
	...
	$(".tab .tab_con .bott .p_function a").val("收藏").click(function() {
		$(this).text("已收藏");
		$(this).css("color", "#999");
		return false;
	});
...
$(function() {
	...
	$(".gz_btn_cont .gz_btn").click(
			function() {
				...
				$(".gz_btn_cont .gz_btn_off").hover(
						function() {
							$(".gz_btn_cont .gz_btn_off").addClass(
									"gz_btn_off2");
						},
						function() {
							$(".gz_btn_cont .gz_btn,.gz_btn_cont .gz_btn_off")
									.removeClass("gz_btn_off2");
						});
				$(".gz_btn_cont .gz_btn_off").click(function() {
					$(this).addClass("gz_btn");
					$(this).removeClass("gz_btn_off");
				});
			});
	$(".person_t_con .gzed_off").click(function() {
		$(this).toggleClass("gzed_on");
	});
	$(".interest_list .bd .guanz_btn").click(function() {
...
$(function() {
	...
	$(
			".info_btn_cont .speak_fb .fs,.person_info .info_btn_cont .speak h2 .close")
			.click(function() {
...
$(function() {
	...
	$(".info_btn_cont .fs,.person_info .info_btn_cont .sixin h2 .close").click(
			function() {
				$(this).parents(".sixin").hide();
			});
});
$(function() {
	$(".side_detail h5 a").click(function() {
		$(this).parents(".side_detail").find("p").toggleClass("height");
	...
	$(".read_select").click(function() {
		$(this).find(".yc").toggleClass("fn-hide");
	});
	$(".book_list li a").click(function() {
		var span = $(this).parents("li").clone();
		span.appendTo(".read_choose ul");
		$(".read_choose ul li em").click(function() {
...
// 圈子邀请、关注
$(function() {
	$(".dr_list .list dd .yq").click(function() {
		$(this).toggleClass("ed");
		if ($(this).hasClass("ed")) {
			$(this).text("已邀请");
		} else {
	...
	$(".dr_list .list dd .gz,.zr_dd_btn").click(function() {
